...
/**
From the first character extracting the integrated json string
@param the target string which maybe contain legal json string
@param the target string length
@return the legal json string's length
**/
    int json_extract_text (u_char * text, int text_len);
